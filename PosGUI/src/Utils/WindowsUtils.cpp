...
namespace PGUI
{
	...
	auto HresultFromWin32(const DWORD errCode) noexcept -> HRESULT
	{
	...
	auto EnableDarkTitleBar(const HWND hWnd, const bool enable) noexcept -> void
	{
		const BOOL var = enable;
	...
	auto WinErrToString(const DWORD errorCode) noexcept -> std::wstring
	{
